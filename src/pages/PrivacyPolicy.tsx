          ...
          <div className="prose prose-sm max-w-none dark:prose-invert space-y-6">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>Location (for data reports and IP blocking purposes only)</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>
                  Data reports for public display (non-identifiable data) to improve our services and report our
                  website's progress
                </li>
            ...
            <section>
              ...
              <p>
                We are committed to protecting your data and do not engage in the sale or tracking of your personal
                information.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                We are committed to maintaining the highest standards of privacy protection. Any changes to our policies
